...
namespace Barely_Cooking_API.Migrations
{
    ...
    [Migration("20240728124622_checkChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.Cake", b =>
                {
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.Cart", b =>
                {
                    b.HasOne("Barely_Cooking_API.Models.Cake", "Cake")
                        .WithMany()
                        .HasForeignKey("CakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Barely_Cooking_API.Models.ShoppingCart", null)
                        .WithMany("Cart")
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.Order", b =>
                {
                    b.HasOne("Barely_Cooking_API.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Barely_Cooking_API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("Barely_Cooking_API.Models.Order", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Barely_Cooking_API.Models.ApplicationUser", null)
                        .WithMany()
